<section id="sl_board_setup_new">
  ...
  <div class="form-group">
    <label class="control-label" for="sl_email"><?php echo _('database_name') ?></label>
    <input type="text" class="form-control" id="name" name="database_name" maxlength="255" required="required" />
   </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label class="control-label" for="sl_password_confirm"><?php echo _('database_host') ?></label>
    <input type="text" class="form-control" id="sl_password_confirm" name="database_host" maxlength="255" required="required" />
  </div>
